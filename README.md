...
| Тёмная тема (десктоп)                       | Светлая тема (десктоп)                       |
|----------------------------------------------|-----------------------------------------------|
| ![Dark desktop](screenshots/desktop-dark.png) | ![Light desktop](screenshots/desktop-light.png) |

| Каталог фильмов                              | Мобильная версия                              |
|----------------------------------------------|-----------------------------------------------|
| ![Catalog](screenshots/catalog.png)          | ![Mobile](screenshots/mobile.png)             |
